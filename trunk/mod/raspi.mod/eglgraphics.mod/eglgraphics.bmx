...
Rem
bbdoc: Create EGL graphics
returns: An EGL graphics object
about:
This is a convenience function that allows you to easily create an EGL graphics context.
End Rem
