...
about:
The EGL Max2D module provides an OpenGL driver for #Max2D.
End Rem
Module RasPI.EGLMax2D
...
Import BRL.Max2D
Import RasPI.EGLGraphics

Private

Global _driver:TEGLMax2DDriver
...
Type TEGLMax2DDriver Extends TMax2DDriver

	Method Create:TEGLMax2DDriver()
	...
	Method SetGraphics( g:TGraphics )
		...
		Assert t And TEGLGraphics( t._graphics )
...
rendering.
End Rem
Function EGLMax2DDriver:TEGLMax2DDriver()
	Global _done
	If Not _done
		_driver=New TEGLMax2DDriver.Create()
		_done=True
	EndIf
	Return _driver
End Function
...
Local driver:TEGLMax2DDriver=EGLMax2DDriver()
